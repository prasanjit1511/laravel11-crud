                ...
                <div class="mb-3">
                 ...
                 @enderror
                   ...
                   <div class="mb-3">
                    ...
                    <textarea placeholder="Description" class="form-control form-control-lg" value="" name="description"  cols="30" rows="5">{{ old('description',$product->description) }}</textarea>
                 </div>
